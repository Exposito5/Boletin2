...
public class Boletin_2_12 {
    ...
    JOptionPane.showMessageDialog(null,"el sueldo líquido son "+(s+c+km+d)+" € \n"+"del cual se le tiene que restar el IRPF y la seguridad social."+"\n EL sueldo tras estas modificaciones es de "+((s+c+km+d)-(((s+c+km+d)*0.18)-36))+" €");
